{{-- DEBUG: NAVIGATION LOADED --}}
<script>
    console.log("✅ navigation.blade.php loaded");
</script>
...
<div class="relative me-4 dropdown">
<a href="javascript:void(0)" id="notifDropdown" class="dropdown-toggle" data-bs-toggle="dropdown">
        🔔
        @if ($unreadCount > 0)
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.dropdown-menu a.dropdown-item').forEach(link => {
            link.addEventListener('click', function (e) {
                e.preventDefault(); // cegah default dulu
                const targetUrl = this.getAttribute('href');
                alert('🔍 Menuju: ' + targetUrl);
                window.location.href = targetUrl; // arahkan secara manual
            });
        });
    });
</script>
